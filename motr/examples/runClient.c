...
void * start_client(void *vargp)
{
    ...
    motr_conf.mc_local_addr = arg->argv2;
...
int main(int argc, char *argv[])
{
    ...
    for (i = 0; i < N_THREAD; i++)
    {
        ...
        // pthread_attr_init(&a);
        // start_client(&array_arg[i]);

        // pthread_create(&t[i], NULL, PrintHello, (void *)&i);
        pthread_create(&t[i], NULL, start_client, &array_arg[i]);
    }
